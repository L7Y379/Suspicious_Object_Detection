...
classer.load_weights('models/class-ot12/2000classer.h5')
ed.load_weights('models/class-ot12/2000ed.h5')
dd.load_weights('models/class-ot12/2000dd.h5')
dis.load_weights('models/class-ot12/2000dis.h5')
k=0
for epoch in range(epochs):
    ...
    if epoch == 3000:
        classer.save_weights('models/class-ot12/3000classer.h5')
        ed.save_weights('models/class-ot12/3000ed.h5')
        dd.save_weights('models/class-ot12/3000dd.h5')
        dis.save_weights('models/class-ot12/3000dis.h5')
print("%d [危险品分类loss: %f,acc: %.2f%%,域分类loss: %f,acc: %.2f%%,重构loss: %f]" % (
epoch, c_loss[0], 100 * c_loss[1],d_loss[0],100 * d_loss[1], sc_fido_loss))
