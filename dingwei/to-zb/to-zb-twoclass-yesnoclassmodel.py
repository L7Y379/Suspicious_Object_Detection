...
# classer.load_weights('models/twoclass-noclassmodel/2000classer.h5')
# classer2.load_weights('models/twoclass-noclassmodel/2000classer2.h5')
# ed.load_weights('models/twoclass-noclassmodel/2000ed.h5')
# dd.load_weights('models/twoclass-noclassmodel/2000dd.h5')
# dis.load_weights('models/twoclass-noclassmodel/2000dis.h5')
k=0
for epoch in range(epochs):
    ...
    if epoch == 500:
        classer.save_weights('models/twoclass-noclassmodel/500classer.h5')
        classer2.save_weights('models/twoclass-noclassmodel/500classer2.h5')
        ed.save_weights('models/twoclass-noclassmodel/500ed.h5')
        dd.save_weights('models/twoclass-noclassmodel/500dd.h5')
        dis.save_weights('models/twoclass-noclassmodel/500dis.h5')
    if epoch == 1000:
        classer.save_weights('models/twoclass-noclassmodel/1000classer.h5')
        classer2.save_weights('models/twoclass-noclassmodel/1000classer2.h5')
        ed.save_weights('models/twoclass-noclassmodel/1000ed.h5')
        dd.save_weights('models/twoclass-noclassmodel/1000dd.h5')
        dis.save_weights('models/twoclass-noclassmodel/1000dis.h5')

    if epoch == 2000:
        classer.save_weights('models/twoclass-noclassmodel/2000classer.h5')
        classer2.save_weights('models/twoclass-noclassmodel/2000classer2.h5')
        ed.save_weights('models/twoclass-noclassmodel/2000ed.h5')
        dd.save_weights('models/twoclass-noclassmodel/2000dd.h5')
        dis.save_weights('models/twoclass-noclassmodel/2000dis.h5')

    if epoch == 3000:
        classer.save_weights('models/twoclass-noclassmodel/3000classer.h5')
        classer2.save_weights('models/twoclass-noclassmodel/3000classer2.h5')
        ed.save_weights('models/twoclass-noclassmodel/3000ed.h5')
        dd.save_weights('models/twoclass-noclassmodel/3000dd.h5')
        dis.save_weights('models/twoclass-noclassmodel/3000dis.h5')

    if epoch == 4000:
        classer.save_weights('models/twoclass-noclassmodel/4000classer.h5')
        classer2.save_weights('models/twoclass-noclassmodel/4000classer2.h5')
        ed.save_weights('models/twoclass-noclassmodel/4000ed.h5')
        dd.save_weights('models/twoclass-noclassmodel/4000dd.h5')
        dis.save_weights('models/twoclass-noclassmodel/4000dis.h5')

print("%d [危险品分类acc: %.2f%%,acc: %.2f%%,域分类loss: %f,acc: %.2f%%,重构loss: %f]" % (
epoch, 100 * c_loss1[1],c_loss2[1],d_loss[0],100 * d_loss[1], sc_fido_loss))
classer.save_weights('models/twoclass-noclassmodel/classer.h5')
classer2.save_weights('models/twoclass-noclassmodel/classer2.h5')
ed.save_weights('models/twoclass-noclassmodel/ed.h5')
dd.save_weights('models/twoclass-noclassmodel/dd.h5')
dis.save_weights('models/twoclass-noclassmodel/dis.h5')
