...
test_feature_12 = all[len(train_feature):(len(train_feature)+len(test_feature_12))]
train_feature_ot_12 = all[(len(train_feature)+len(test_feature_12)):]
...
# classer.load_weights('/content/drive/MyDrive/AAAA/models/class/to-zb/2000classer.h5')
# ed.load_weights('/content/drive/MyDrive/AAAA/models/class/to-zb/2000ed.h5')
# dd.load_weights('/content/drive/MyDrive/AAAA/models/class/to-zb/2000dd.h5')
# dis.load_weights('/content/drive/MyDrive/AAAA/models/class/to-zb/2000dis.h5')
k=0
for epoch in range(epochs):
    ...
    if epoch % 2 == 0:
        ...
        if ((kk1 <= 155) and (kk2 <= 155)and (kk3 <= 250)):
            ...
            d = 100 * d_loss[1]
            d = int(d)
            file =r'/content/drive/MyDrive/AAAA/models/class/result_dingwei.txt'
