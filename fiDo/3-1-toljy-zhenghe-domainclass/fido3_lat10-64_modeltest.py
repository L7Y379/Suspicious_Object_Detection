...
discriminator.load_weights('models/aae-csi2/2500discriminator.h5')
discriminator2.load_weights('models/aae-csi2/2500discriminator2.h5')
encoder.load_weights('models/aae-csi2/2500encoder.h5')
encoder2.load_weights('models/aae-csi2/2500encoder2.h5')
adversarial_autoencoder.load_weights('models/aae-csi2/2500adversarial_autoencoder.h5')
adversarial_autoencoder2.load_weights('models/aae-csi2/2500adversarial_autoencoder2.h5')
