...
for epoch in range(epochs):
    ...
    # Train the discriminator
    d_loss_real = discriminator.train_on_batch(latent_real, valid2)
    d_loss_fake = discriminator.train_on_batch(latent_fake, fake2)
    d_loss = 0.5 * np.add(d_loss_real, d_loss_fake)
    ...
    # Train the generator
    g_loss = adversarial_autoencoder.train_on_batch(imgs, [imgs, valid2])
