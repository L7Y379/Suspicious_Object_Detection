...
for epoch in range(epochs):
    ...
    if epoch==1800:
        discriminator.save_weights('models/aae-csi2/1800discriminator.h5')
        #discriminator2.save_weights('models/aae-csi2-new/discriminator2.h5')
        encoder.save_weights('models/aae-csi2/1800encoder.h5')
        #encoder2.save_weights('models/aae-csi2-new/encoder2.h5')
        adversarial_autoencoder.save_weights('models/aae-csi2/1800adversarial_autoencoder.h5')
...
for epoch in range(epochs):
    ...
    if epoch==1800:
        ...
        discriminator2.save_weights('models/aae-csi2/1800discriminator2.h5')
        #encoder.save_weights('models/aae-csi2-new/encoder.h5')
        encoder2.save_weights('models/aae-csi2/1800encoder2.h5')
        #adversarial_autoencoder.save_weights('models/aae-csi2-new/adversarial_autoencoder.h5')
        adversarial_autoencoder2.save_weights('models/aae-csi2/1800adversarial_autoencoder2.h5')
    # Save generated images (every sample interval, e.g. every 100th epoch)
    # if epoch % sample_interval == 0:
