...
classer.save_weights('models/fido3_lat10-64upclasser(1)/classer.h5')
ed.save_weights('models/fido3_lat10-64upclasser(1)/ed.h5')
dd.save_weights('models/fido3_lat10-64upclasser(1)/dd.h5')
sc_fido.save_weights('models/fido3_lat10-64upclasser(1)/sc_fido.h5')
