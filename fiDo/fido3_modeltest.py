...
classer.load_weights('models/fido3/classer.h5')
ed.load_weights('models/fido3/ed.h5')
dd.load_weights('models/fido3/dd.h5')
sc_fido.load_weights('models/fido3/sc_fido.h5')
