...
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        ...
        if ((acc_non_pre3>=0.65)and(acc_yes_pre3>=0.61)):
            ...
            print(k)
            classer.save_weights('models/jiandulkrelu6/' + str(epoch) +str(acc_non_pre3)+str(acc_yes_pre3)+ 'classer.h5')
            ed.save_weights('models/jiandulkrelu6/' + str(epoch) +str(acc_non_pre3)+str(acc_yes_pre3)+ 'ed.h5')
            ...
            class_model.save_weights('models/jiandulkrelu6/' + str(epoch) +str(acc_non_pre3)+str(acc_yes_pre3)+ 'class_model.h5')
