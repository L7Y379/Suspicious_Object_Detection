...
# # Training
# classer.load_weights('models/fido3_lat10-64upclasser-classer800/3000classer.h5')
# ed.load_weights('models/fido3_lat10-64upclasser-classer800/3000ed.h5')
# dd.load_weights('models/fido3_lat10-64upclasser-classer800/3000dd.h5')
# dis.load_weights('models/fido3_lat10-64upclasser-classer800/3000dis.h5')
# dis_model.load_weights('models/fido3_lat10-64upclasser-classer800/3000dis_model.h5')
# sc_fido.load_weights('models/fido3_lat10-64upclasser-classer800/3000sc_fido.h5')
i=0
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        ...
        if ((100 * c_loss[1] >= 96) and (100 * d_loss[1] >= 90)):
            i=i+1
            classer.save_weights('models/fido3_lat10-64upclasser-classer800/'+str(epoch)+'classer.h5')
            ed.save_weights('models/fido3_lat10-64upclasser-classer800/'+str(epoch)+'ed.h5')
            dd.save_weights('models/fido3_lat10-64upclasser-classer800/'+str(epoch)+'dd.h5')
            dis.save_weights('models/fido3_lat10-64upclasser-classer800/'+str(epoch)+'dis.h5')
            dis_model.save_weights('models/fido3_lat10-64upclasser-classer800/'+str(epoch)+'dis_model.h5')
            sc_fido.save_weights('models/fido3_lat10-64upclasser-classer800/'+str(epoch)+'sc_fido.h5')
            if i==8:
                break
    if epoch==1000:
        classer.save_weights('models/fido3_lat10-64upclasser-classer800/1000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser-classer800/1000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser-classer800/1000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser-classer800/1000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser-classer800/1000dis_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser-classer800/1000sc_fido.h5')
    if epoch==2000:
        classer.save_weights('models/fido3_lat10-64upclasser-classer800/2000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser-classer800/2000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser-classer800/2000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser-classer800/2000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser-classer800/2000dis_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser-classer800/2000sc_fido.h5')
    if epoch==3000:
        classer.save_weights('models/fido3_lat10-64upclasser-classer800/3000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser-classer800/3000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser-classer800/3000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser-classer800/3000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser-classer800/3000dis_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser-classer800/3000sc_fido.h5')
classer.save_weights('models/fido3_lat10-64upclasser-classer800/classer.h5')
ed.save_weights('models/fido3_lat10-64upclasser-classer800/ed.h5')
dd.save_weights('models/fido3_lat10-64upclasser-classer800/dd.h5')
dis.save_weights('models/fido3_lat10-64upclasser-classer800/dis.h5')
dis_model.save_weights('models/fido3_lat10-64upclasser-classer800/dis_model.h5')
sc_fido.save_weights('models/fido3_lat10-64upclasser-classer800/sc_fido.h5')
