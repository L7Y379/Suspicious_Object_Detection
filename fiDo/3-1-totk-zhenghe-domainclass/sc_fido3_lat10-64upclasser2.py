...
def build_dd(latent_dim2, img_shape):
    ...
    model.add(Dense(800))
    model.add(LeakyReLU(alpha=0.2))
    # models.add(Dense(512, input_dim=latent_dim2))
...
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        ...
        if ((100 * c_loss[1] >= 99.7) and (100 * d_loss[1] >= 90)):
            i=i+1
            classer.save_weights('models/fido3_lat10-64upclasser2-dis800/' + str(epoch) + 'classer.h5')
            ed.save_weights('models/fido3_lat10-64upclasser2-dis800/' + str(epoch) + 'ed.h5')
            dd.save_weights('models/fido3_lat10-64upclasser2-dis800/' + str(epoch) + 'dd.h5')
            dis.save_weights('models/fido3_lat10-64upclasser2-dis800/' + str(epoch) + 'dis.h5')
            dis_model.save_weights('models/fido3_lat10-64upclasser2-dis800/' + str(epoch) + 'dis_model.h5')
            class_model.save_weights('models/fido3_lat10-64upclasser2-dis800/' + str(epoch) + 'class_model.h5')
            sc_fido.save_weights('models/fido3_lat10-64upclasser2-dis800/' + str(epoch) + 'sc_fido.h5')
            if i == 8:
                break
    if epoch == 1000:
        classer.save_weights('models/fido3_lat10-64upclasser2-dis800/1000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2-dis800/1000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2-dis800/1000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2-dis800/1000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2-dis800/1000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2-dis800/1000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2-dis800/1000sc_fido.h5')
    if epoch == 2000:
        classer.save_weights('models/fido3_lat10-64upclasser2-dis800/2000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2-dis800/2000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2-dis800/2000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2-dis800/2000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2-dis800/2000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2-dis800/2000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2-dis800/2000sc_fido.h5')
    if epoch == 3000:
        classer.save_weights('models/fido3_lat10-64upclasser2-dis800/3000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2-dis800/3000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2-dis800/3000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2-dis800/3000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2-dis800/3000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2-dis800/3000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2-dis800/3000sc_fido.h5')
    if epoch == 4000:
        classer.save_weights('models/fido3_lat10-64upclasser2-dis800/4000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2-dis800/4000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2-dis800/4000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2-dis800/4000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2-dis800/4000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2-dis800/4000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2-dis800/4000sc_fido.h5')
print("%d [危险品分类loss: %f,acc: %.2f%%,域分类loss: %f,acc: %.2f%%,重构loss: %f]" % (
epoch, c_loss[0], 100 * c_loss[1],d_loss[0],100 * d_loss[1], sc_fido_loss))
classer.save_weights('models/fido3_lat10-64upclasser2-dis800/classer.h5')
ed.save_weights('models/fido3_lat10-64upclasser2-dis800/ed.h5')
dd.save_weights('models/fido3_lat10-64upclasser2-dis800/dd.h5')
dis.save_weights('models/fido3_lat10-64upclasser2-dis800/dis.h5')
dis_model.save_weights('models/fido3_lat10-64upclasser2-dis800/dis_model.h5')
class_model.save_weights('models/fido3_lat10-64upclasser2-dis800/class_model.h5')
sc_fido.save_weights('models/fido3_lat10-64upclasser2-dis800/sc_fido.h5')
