...
for epoch in range(epochs):
    ...
    if (100 * c_loss>=94):
        break
print("%d [危险品分类loss: %f,acc: %.2f%%,域分类loss: %f,acc: %.2f%%,重构loss: %f]" % (epoch, c_loss[0], 100 * c_loss[1],d_loss[0],100 * d_loss[1], sc_fido_loss))

classer.save_weights('models/fido3_lat10-64upclasser+yuandata/classer.h5')
ed.save_weights('models/fido3_lat10-64upclasser+yuandata/ed.h5')
dd.save_weights('models/fido3_lat10-64upclasser+yuandata/dd.h5')
dis.save_weights('models/fido3_lat10-64upclasser+yuandata/dis.h5')
dis_model.save_weights('models/fido3_lat10-64upclasser+yuandata/dis_model.h5')
sc_fido.save_weights('models/fido3_lat10-64upclasser+yuandata/sc_fido.h5')
