    ...
    for epoch in range(epochs):
        ...
        if epoch % 10 == 0:
            ...
            for o in range(4):  # 四个人的数据
                #print(test_feature.shape)
                non_mid = lstm_model.predict(test_feature[o * 20:(o + 1) * 20])  # 每个人30条数据，10条跌倒，10条非跌倒
...
def train_test():
    ...
    model_path = "D:/my bad/Suspicious object detection/Suspicious_Object_Detection/yue/fall_detect/models/1112_1117_1119_notdx_lstm.h5"
    ...
    dirPath_test = "D:/my bad/Suspicious object detection/data/fall/notdx/1115_pre"
