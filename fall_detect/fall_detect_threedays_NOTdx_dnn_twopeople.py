...
def build_dnn():
    rnn=Sequential()
    rnn.add(Flatten())
    rnn.add(Dense(5000, activation="relu"))
...
def train_test():
    ...
    model_path = "D:/my bad/Suspicious object detection/Suspicious_Object_Detection/yue/fall_detect/models/1124_pre_timeaf.h5"
    ...
    dirPath_test = "D:/my bad/Suspicious object detection/data/fall/notdx/1124_pre_timeaf"
