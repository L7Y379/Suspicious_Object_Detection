...
#autoencoder.compile(optimizer='adam', loss='mse')
autoencoder.summary()
autoencoder.fit(train_feature_nosiy[:19200], train_feature[:19200], epochs=300, batch_size=128, verbose=1, validation_data=(test_feature_nosiy[:4800], test_feature[:4800]))
