...
#autoencoder.compile(optimizer='adam', loss='mse')
autoencoder.summary()
autoencoder.fit(train_feature_nosiy[:9600], train_feature[:9600], epochs=300, batch_size=128, verbose=1, validation_data=(test_feature_nosiy[:2400], test_feature[:2400]))
