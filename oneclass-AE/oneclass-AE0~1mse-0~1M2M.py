...
#autoencoder.compile(optimizer='adam', loss='mse')
autoencoder.summary()
autoencoder.fit(train_feature_nosiy[:4800], train_feature[:4800], epochs=200, batch_size=128, verbose=1, validation_data=(test_feature_nosiy[:2400], test_feature[:2400]))
