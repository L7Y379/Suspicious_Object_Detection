...
def read_bf_file(filename, curpin, decoder="python"):
    ...
    return dicts, curpin
def get_data(path,sampleNum=500):
    curpin = 0
    ...
    amplitude_list_new = amplitude_list_new[0:sampleNum] ##获取1000条数据是这样么
...
def pre_handle(raw_data):
    ...
    print("数据已预处理")
    return data
path1=r"D:\my bad\CSI_DATA\fall_detection\fall_detection\data_model_dir\data_dir\fall_detection\\ly1.dat"
path2=r"D:\my bad\CSI_DATA\fall_detection\fall_detection\data_model_dir\data_dir\fall_detection\\ly2.dat"
path3=r"D:\my bad\CSI_DATA\fall_detection\fall_detection\data_model_dir\data_dir\fall_detection\\ly3.dat"
path4=r"D:\my bad\CSI_DATA\fall_detection\fall_detection\data_model_dir\data_dir\fall_detection\\ly4.dat"
path5=r"D:\my bad\CSI_DATA\fall_detection\fall_detection\data_model_dir\data_dir\fall_detection\\ly5.dat"
path6=r"D:\my bad\CSI_DATA\fall_detection\fall_detection\data_model_dir\data_dir\fall_detection\\ly6.dat"
