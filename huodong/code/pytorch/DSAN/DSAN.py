...
target_train_loader = data_loader.load_training(root_path, target_train, batch_size, kwargs)
target_test_loader = data_loader.load_testing(root_path, target_test, batch_size, kwargs)
...
def test(model):
    ...
    with torch.no_grad():
        ...
        print('\n{} set: Average loss: {:.4f}, Accuracy: {}/{} ({:.2f}%)\n'.format(
            target_test, test_loss, correct, len_target_dataset,
...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs + 1):
        ...
        print('source: {} to target: {} max correct: {} max accuracy{: .2f}%\n'.format(
              source_name, target_test, correct, 100. * correct / len_target_dataset ))
