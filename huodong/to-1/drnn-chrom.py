...
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        ...
        if ((k1 >= 0.65) and(kk1 >= 0.65)):
            ...
            d = 100 * d_loss[1]
            d = int(d)
            file = r'/content/drive/MyDrive/huodong/to-1/models/drnn/result_drnn.txt'
            ...
            f.close()  # 关闭文件
    if epoch == 500:
        drnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/drnn/500drnn_model.h5')
    if epoch == 1000:
        drnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/drnn/1000drnn_model.h5')
    if epoch == 2000:
        drnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/drnn/2000drnn_model.h5')
    if epoch == 3000:
        drnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/drnn/3000drnn_model.h5')
    if epoch == 4000:
        drnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/drnn/4000drnn_model.h5')

drnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/drnn/drnn_model.h5')
