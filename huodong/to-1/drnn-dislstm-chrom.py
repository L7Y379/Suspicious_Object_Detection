...
# crnn_model.load_weights('/content/drive/MyDrive/huodong/to-1/models/crnn-dislstm-to-8/2000crnn_model.h5')
# dis.load_weights('/content/drive/MyDrive/huodong/to-1/models/crnn-dislstm-to-8/2000dis.h5')
k=0
for epoch in range(epochs):
    ...
    if epoch % 4 == 0:
        ...
        if ((k1 >= 0.90) and(kk1 >= 0.65)and(d_loss[1] >= 0.90)):
            k1 = k1 * 1000
            k1 = int(k1)
            ...
            d = 100 * d_loss[1]
            d = int(d)
            file = r'/content/drive/MyDrive/huodong/to-1/models/crnn-dislstm-to-8/result_crnn-dislstm-to-8.txt'
            ...
            f.close()  # 关闭文件
    if epoch == 1000:
        crnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/crnn-dislstm-to-8/1000crnn_model.h5')
        dis.save_weights('/content/drive/MyDrive/huodong/to-1/models/crnn-dislstm-to-8/1000dis.h5')
    if epoch == 2000:
        crnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/crnn-dislstm-to-8/2000crnn_model.h5')
        dis.save_weights('/content/drive/MyDrive/huodong/to-1/models/crnn-dislstm-to-8/2000dis.h5')
    if epoch == 3000:
        crnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/crnn-dislstm-to-8/3000crnn_model.h5')
        dis.save_weights('/content/drive/MyDrive/huodong/to-1/models/crnn-dislstm-to-8/3000dis.h5')
    if epoch == 4000:
        crnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/crnn-dislstm-to-8/4000crnn_model.h5')
        dis.save_weights('/content/drive/MyDrive/huodong/to-1/models/crnn-dislstm-to-8/4000dis.h5')
