...
# encoded_repr3_dis = Reshape(target_shape=(batch_size*200,90))(encoded_repr3_dis)
...
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        ...
        if ((k1 >= 0.65) and(kk1 >= 0.65)):
            ...
            c = 100 * crnn_loss[1]
            c = int(c)
            file = r'models/jiandu-crnn/result_jiandu-crnn.txt'
            ...
            f.close()  # 关闭文件
    if epoch == 500:
        crnn_model.save_weights('models/jiandu-crnn/500crnn_model.h5')
    if epoch == 1000:
        crnn_model.save_weights('models/jiandu-crnn/1000crnn_model.h5')
    if epoch == 2000:
        crnn_model.save_weights('models/jiandu-crnn/2000crnn_model.h5')
    if epoch == 3000:
        crnn_model.save_weights('models/jiandu-crnn/3000crnn_model.h5')
    if epoch == 4000:
        crnn_model.save_weights('models/jiandu-crnn/4000crnn_model.h5')

crnn_model.save_weights('models/jiandu-crnn/crnn_model.h5')
