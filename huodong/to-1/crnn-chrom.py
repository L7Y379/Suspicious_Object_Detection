...
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        ...
        if ((k1 >= 0.65) and(kk1 >= 0.65)):
            ...
            c = 100 * crnn_loss[1]
            c = int(c)
            file = r'/content/drive/MyDrive/huodong/to-1/models/crnn/result_crnn.txt'
            ...
            f.close()  # 关闭文件
    if epoch == 500:
        crnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/crnn/500crnn_model.h5')
    if epoch == 1000:
        crnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/crnn/1000crnn_model.h5')
    if epoch == 2000:
        crnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/crnn/2000crnn_model.h5')
    if epoch == 3000:
        crnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/crnn/3000crnn_model.h5')
    if epoch == 4000:
        crnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/crnn/4000crnn_model.h5')

crnn_model.save_weights('/content/drive/MyDrive/huodong/to-1/models/crnn/crnn_model.h5')
