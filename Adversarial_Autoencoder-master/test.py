        ...
        if train_model:
            ...
            for i in range(n_epochs):
                ...
                if i % 2 == 0:
                    ...
                    for b in range(1, n_batches1 + 1):
                        train_feature = train_feature_all[(b - 1) * 100:b * 100]
                        train_feature_mid = sess.run(encoder_output, feed_dict={x_input: train_feature})
                        if (b == 1):
                            train_feature_mid_all = train_feature_mid
                        else:
                            train_feature_mid_all = np.vstack((train_feature_mid_all, train_feature_mid))
                ...
                for b in range(1, n_batches + 1):
                    ...
                    sess.run(discriminator_optimizer, feed_dict={x_input: train_feature, x_target: train_feature,
