...
all_data=np.concatenate((all_data,train_feature_ot_cut), axis=0)
all_data=np.concatenate((all_data,train_feature_ot_cut), axis=0)
print(all_data.shape)
latent_dim = 270
latent_dim2=540
...
# # Training
# classer.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/2000classer.h5')
# ed.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/2000ed.h5')
# dd.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/2000dd.h5')
# dis.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/2000dis.h5')
# dis_model.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/2000dis_model.h5')
# class_model.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/2000class_model.h5')
# sc_fido.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/2000sc_fido.h5')
...
for epoch in range(epochs):
    ...
    if epoch % 1 == 0:
        ...
        if ((acc_non_pre3_vot >= 0.6) and (acc_yes_pre3_vot >= 0.6) and (c_loss[1] >= 0.65) and (
            ...
            c = int(c)
            print(k)
            classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/' + str(epoch) + '_' + str(c) + 'y' + str(
            ...
            ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/' + str(epoch) + '_' + str(c) + 'y' + str(
                acc_non_pre) + '_' + str(acc_yes_pre) + '_' + str(acc_non_pre_vot) + '_' + str(
                acc_yes_pre_vot) + 'm' + str(acc_non_pre3) + '_' + str(acc_yes_pre3) + '_' + str(
                acc_non_pre3_vot) + '_' + str(acc_yes_pre3_vot) + 'm' + str(acc_non_pre4) + '_' + str(
                acc_yes_pre4) + '_' + str(acc_non_pre4_vot) + '_' + str(acc_yes_pre4_vot) + 'ed.h5')
            # dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/' + str(epoch) + '_' + str(c) + 'y' + str(
            #         acc_non_pre) + '_' + str(acc_yes_pre) + '_' + str(acc_non_pre_vot) + '_' + str(
            #         acc_yes_pre_vot) + 'm' + str(acc_non_pre3) + '_' + str(acc_yes_pre3) + '_' + str(
            #         acc_non_pre3_vot) + '_' + str(acc_yes_pre3_vot) + 'm' + str(acc_non_pre4) + '_' + str(
            #         acc_yes_pre4) + '_' + str(acc_non_pre4_vot) + '_' + str(acc_yes_pre4_vot) + 'dd.h5')
            # dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/' + str(epoch) + '_' + str(c) + 'y' + str(
            #         acc_non_pre) + '_' + str(acc_yes_pre) + '_' + str(acc_non_pre_vot) + '_' + str(
            #         acc_yes_pre_vot) + 'm' + str(acc_non_pre3) + '_' + str(acc_yes_pre3) + '_' + str(
            #         acc_non_pre3_vot) + '_' + str(acc_yes_pre3_vot) + 'm' + str(acc_non_pre4) + '_' + str(
            #         acc_yes_pre4) + '_' + str(acc_non_pre4_vot) + '_' + str(acc_yes_pre4_vot) + 'dis.h5')
            # dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/' + str(epoch) + '_' + str(c) + 'y' + str(
            #         acc_non_pre) + '_' + str(acc_yes_pre) + '_' + str(acc_non_pre_vot) + '_' + str(
            #         acc_yes_pre_vot) + 'm' + str(acc_non_pre3) + '_' + str(acc_yes_pre3) + '_' + str(
            #         acc_non_pre3_vot) + '_' + str(acc_yes_pre3_vot) + 'm' + str(acc_non_pre4) + '_' + str(
            #         acc_yes_pre4) + '_' + str(acc_non_pre4_vot) + '_' + str(acc_yes_pre4_vot) + 'dis_model.h5')
            # class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/' + str(epoch) + '_' + str(c) + 'y' + str(
            #         acc_non_pre) + '_' + str(acc_yes_pre) + '_' + str(acc_non_pre_vot) + '_' + str(
            #         acc_yes_pre_vot) + 'm' + str(acc_non_pre3) + '_' + str(acc_yes_pre3) + '_' + str(
            #         acc_non_pre3_vot) + '_' + str(acc_yes_pre3_vot) + 'm' + str(acc_non_pre4) + '_' + str(
            #         acc_yes_pre4) + '_' + str(acc_non_pre4_vot) + '_' + str(acc_yes_pre4_vot) + 'class_model.h5')
            # sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/' + str(epoch) + '_' + str(c) + 'y' + str(
            #         acc_non_pre) + '_' + str(acc_yes_pre) + '_' + str(acc_non_pre_vot) + '_' + str(
            #         acc_yes_pre_vot) + 'm' + str(acc_non_pre3) + '_' + str(acc_yes_pre3) + '_' + str(
            #         acc_non_pre3_vot) + '_' + str(acc_yes_pre3_vot) + 'm' + str(acc_non_pre4) + '_' + str(
            #         acc_yes_pre4) + '_' + str(acc_non_pre4_vot) + '_' + str(acc_yes_pre4_vot) + 'sc_fido.h5')
    if epoch == 500:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/500classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/500ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/500dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/500dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/500dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/500class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/500sc_fido.h5')
    if epoch == 1000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/1000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/1000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/1000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/1000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/1000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/1000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/1000sc_fido.h5')
    if epoch == 2000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/2000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/2000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/2000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/2000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/2000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/2000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/2000sc_fido.h5')
    if epoch == 3000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/3000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/3000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/3000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/3000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/3000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/3000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/3000sc_fido.h5')
    if epoch == 4000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/4000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/4000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/4000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/4000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/4000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/4000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/4000sc_fido.h5')
print("%d [危险品分类loss: %f,acc: %.2f%%,域分类loss: %f,acc: %.2f%%,重构loss: %f]" % (
epoch, c_loss[0], 100 * c_loss[1],d_loss[0],100 * d_loss[1], sc_fido_loss))
classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/classer.h5')
ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/ed.h5')
dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/dd.h5')
dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/dis.h5')
dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/dis_model.h5')
class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/class_model.h5')
sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15+M/sc_fido.h5')
