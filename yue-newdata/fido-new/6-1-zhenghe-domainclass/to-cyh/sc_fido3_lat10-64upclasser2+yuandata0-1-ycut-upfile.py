...
def file_array():
    ...
    testfile = []
    testfile2 = []
    for name in ['zb','zhw', 'gzy', 'ljc', 'lyx', 'tk']:
        for j in ["0"]:  # "1S", "2S"
...
# # Training
classer.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/3000classer.h5')
ed.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/3000ed.h5')
dd.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/3000dd.h5')
dis.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/3000dis.h5')
dis_model.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/3000dis_model.h5')
class_model.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/3000class_model.h5')
sc_fido.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/3000sc_fido.h5')
...
for epoch in range(epochs):
    ...
    if epoch % 1 == 0:
        ...
        if ((acc_non_pre_vot >= 0.86) and (acc_yes_pre_vot >= 0.86)and(c_loss[1] >= 0.61) and (acc_non_pre4_vot >= 0.8) and (acc_yes_pre4_vot >= 0.8)):
            k = k + 1
            ...
            dis.save_weights(
                'models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/' + str(epoch) + '_' + str(c) + 'y' + str(
                    acc_non_pre) + '_' + str(acc_yes_pre) + '_' + str(acc_non_pre_vot) + '_' + str(
                    acc_yes_pre_vot) + 'm' + str(acc_non_pre3) + '_' + str(acc_yes_pre3) + '_' + str(
                    acc_non_pre3_vot) + '_' + str(acc_yes_pre3_vot) + 'm' + str(acc_non_pre4) + '_' + str(
    ...
    if epoch == 2000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/5000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/5000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/5000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/5000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/5000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/5000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/5000sc_fido.h5')
    if epoch == 3000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/6000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/6000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/6000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/6000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/6000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/6000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/6000sc_fido.h5')
    if epoch == 4000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/4000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/4000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/4000dd.h5')
