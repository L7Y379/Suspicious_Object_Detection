...
def file_array3mid():
    ...
    trainfile = trainfile[np.argsort(k)]
    trainfile = trainfile[:20]
    testfile = np.concatenate((trainfile[8:12], trainfile[19:19]), axis=0)
    trainfile = np.concatenate((trainfile[:8], trainfile[12:19]), axis=0)
    # np.random.shuffle(trainfile)
    alltrain = np.concatenate((alltrain, trainfile), axis=0)
    alltest = np.concatenate((alltest, testfile), axis=0)
...
classer.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/3978_92y75_73_100_100m58_54_66_80m58_54_66_80classer.h5')
ed.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-ycut15-upfile/3978_92y75_73_100_100m58_54_66_80m58_54_66_80ed.h5')
