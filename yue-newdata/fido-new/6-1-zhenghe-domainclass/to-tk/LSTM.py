...
print(train_feature_cut.shape)
print(train_label_cut.shape)
...
X_train1 =train_feature_cut[:90]
print(X_train1.shape)
X_test1 =test_feature_cut[:15]
print(X_test1.shape)

X_train2 =train_feature_cut[90:]
...
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        ...
        print()
        if ((acc_non_pre >= 0.7) and (acc_yes_pre >= 0.7) and (l_loss[1] >= 0.65) and (
                acc_non_pre3 >= 0.7) and (acc_yes_pre3 >= 0.7)):
            k = k + 1
