...
import pandas as pd
import os
from keras.layers import regularizers,Dropout
...
# # Training
classer.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/1000classer.h5')
ed.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/1000ed.h5')
#dd.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/4000dd.h5')
dis.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/1000dis.h5')
dis_model.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/1000dis_model.h5')
class_model.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/1000class_model.h5')
#sc_fido.load_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/4000sc_fido.h5')
k=0
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        print("%d [危险品分类loss: %f,acc: %.2f%%,域分类loss: %f,acc: %.2f%%]" % (
        epoch, c_loss[0], 100 * c_loss[1],d_loss[0],100 * d_loss[1]))
        ...
        print()
        if ((acc_non_pre3 >= 0.6) and (acc_yes_pre3 >= 0.6)and(c_loss[1] >= 0.7)):
            k = k + 1
            ...
            acc_non_pre3 = acc_non_pre3 * 1000
            acc_non_pre3 = int(acc_non_pre3)
            acc_yes_pre3 = acc_yes_pre3 * 1000
            acc_yes_pre3 = int(acc_yes_pre3)
            acc_non_pre3_vot = acc_non_pre3_vot * 1000
            acc_non_pre3_vot = int(acc_non_pre3_vot)
            acc_yes_pre3_vot = acc_yes_pre3_vot * 1000
            acc_yes_pre3_vot = int(acc_yes_pre3_vot)
            c=100 * c_loss[1]
            c=int(c)
            print(k)
            classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/' + str(epoch)+'_'+ str(c)+'_yuantest' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'classer.h5')
            ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/' + str(epoch) +'_'+str(c)+'_yuantest' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'ed.h5')
            #dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'dd.h5')
            dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/' + str(epoch) +'_'+str(c)+'_yuantest' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'dis.h5')
            dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/' + str(epoch) +str(c)+'_yuantest'+'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'dis_model.h5')
            class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/' + str(epoch)+str(c)+'_yuantest' +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'class_model.h5')
            #sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'sc_fido.h5')
    if epoch == 1000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/1000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/1000ed.h5')
        #dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/1000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/1000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/1000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/1000class_model.h5')
        #sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/1000sc_fido.h5')
    if epoch == 2000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/2000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/2000ed.h5')
        #dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/2000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/2000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/2000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/2000class_model.h5')
        #sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/2000sc_fido.h5')
    if epoch == 3000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/3000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/3000ed.h5')
        #dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/3000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/3000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/3000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/3000class_model.h5')
        #sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/3000sc_fido.h5')
    if epoch == 4000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/4000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/4000ed.h5')
        #dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/4000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/4000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/4000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/4000class_model.h5')
        #sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/4000sc_fido.h5')
print("%d [危险品分类loss: %f,acc: %.2f%%,域分类loss: %f,acc: %.2f%%]" % (
epoch, c_loss[0], 100 * c_loss[1],d_loss[0],100 * d_loss[1]))
classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/classer.h5')
ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/ed.h5')
#dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/dd.h5')
dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/dis.h5')
dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/dis_model.h5')
class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/class_model.h5')
#sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1-nodd2/sc_fido.h5')
