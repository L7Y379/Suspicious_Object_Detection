...
def build_ed(latent_dim, img_shape):
    model = Sequential()
    model.add(Conv2D(32, kernel_size=(4, 4), input_shape=img_shape))
    model.add(LeakyReLU(alpha=0.2))
    ...
    return Model(img, latent_repr)
def build_ed2(latent_dim, img_shape):
    model = Sequential()
    model.add(Conv2D(32, kernel_size=(4, 4), input_shape=img_shape))
    model.add(LeakyReLU(alpha=0.2))
    model.add(MaxPooling2D(pool_size=(2, 2)))
...
ed2 = build_ed2(latent_dim, img_shape)
dd = build_dd(latent_dim2, img_shape)


# img_shape = (batch_size,img_rows, img_cols, channels)
img3 = Input(shape=img_shape)
encoded_repr3 = ed(img3)
encoded_repr4 = ed2(img3)
encoded_repr3_4 = concatenate([encoded_repr3, encoded_repr4],axis=1)
# def conect(args):
#     encoded_repr3, encoded_repr4 = args
#     return np.concatenate((encoded_repr3,encoded_repr4), axis=-1)
# encoded_repr3_4=Lambda(conect)([encoded_repr3,encoded_repr4])
reconstructed_img3_4 = dd(encoded_repr3_4)
sc_fido = Model(img3,reconstructed_img3_4)
...
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        ...
        print()
        if ((acc_non_pre3 >= 0.65) and (acc_yes_pre3 >= 0.61)):
            k = k + 1
            ...
            print(k)
            classer.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'classer.h5')
            ed.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'ed.h5')
            dd.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'dd.h5')
            dis.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'dis.h5')
            dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'dis_model.h5')
            class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'class_model.h5')
            sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'sc_fido.h5')
    if epoch == 1000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/1000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/1000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/1000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/1000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/1000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/1000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/1000sc_fido.h5')
    if epoch == 2000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/2000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/2000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/2000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/2000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/2000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/2000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/2000sc_fido.h5')
    if epoch == 3000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/3000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/3000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/3000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/3000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/3000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/3000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/3000sc_fido.h5')
    if epoch == 4000:
        classer.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/4000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/4000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/4000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/4000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/4000dis_model.h5')
        class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/4000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/4000sc_fido.h5')
print("%d [危险品分类loss: %f,acc: %.2f%%,域分类loss: %f,acc: %.2f%%,重构loss: %f]" % (
epoch, c_loss[0], 100 * c_loss[1],d_loss[0],100 * d_loss[1], sc_fido_loss))
classer.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/classer.h5')
ed.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/ed.h5')
dd.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/dd.h5')
dis.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/dis.h5')
dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/dis_model.h5')
class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/class_model.h5')
sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed-cnn/sc_fido.h5')
