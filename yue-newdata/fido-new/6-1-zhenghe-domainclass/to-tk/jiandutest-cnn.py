...
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        ...
        if ((acc_non_pre3>=0.65)and(acc_yes_pre3>=0.61)):
            ...
            print(k)
            classer.save_weights('models/jiandu-cnn/' + str(epoch)+'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'classer.h5')
            ed.save_weights('models/jiandu-cnn/' + str(epoch)+'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+  'ed.h5')
            # dd.save_weights('models/jiandu-cnn/' + str(epoch) + 'dd.h5')
            # dis.save_weights('models/jiandu-cnn/' + str(epoch) + 'dis.h5')
            # dis_model.save_weights('models/jiandu-cnn/' + str(epoch) + 'dis_model.h5')
            class_model.save_weights('models/jiandu-cnn/' + str(epoch)+'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot) + 'class_model.h5')
            # sc_fido.save_weights('models/jiandu-cnn/' + str(epoch) + 'sc_fido.h5')
    if epoch == 1000:
        classer.save_weights('models/jiandu-cnn/1000classer.h5')
        ed.save_weights('models/jiandu-cnn/1000ed.h5')
        # dd.save_weights('models/jiandu-cnn/dd.h5')
        # dis.save_weights('models/jiandu-cnn/dis.h5')
        # dis_model.save_weights('models/jiandu-cnn/dis_model.h5')
        class_model.save_weights('models/jiandu-cnn/1000class_model.h5')
        # sc_fido.save_weights('models/jiandu-cnn/sc_fido.h5')
    if epoch == 2000:
        classer.save_weights('models/jiandu-cnn/2000classer.h5')
        ed.save_weights('models/jiandu-cnn/2000ed.h5')
        # dd.save_weights('models/jiandu-cnn/dd.h5')
        # dis.save_weights('models/jiandu-cnn/dis.h5')
        # dis_model.save_weights('models/jiandu-cnn/dis_model.h5')
        class_model.save_weights('models/jiandu-cnn/2000class_model.h5')
        # sc_fido.save_weights('models/jiandu-cnn/sc_fido.h5')
    if epoch == 3000:
        classer.save_weights('models/jiandu-cnn/3000classer.h5')
        ed.save_weights('models/jiandu-cnn/3000ed.h5')
        # dd.save_weights('models/jiandu-cnn/dd.h5')
        # dis.save_weights('models/jiandu-cnn/dis.h5')
        # dis_model.save_weights('models/jiandu-cnn/dis_model.h5')
        class_model.save_weights('models/jiandu-cnn/3000class_model.h5')
        # sc_fido.save_weights('models/jiandu-cnn/sc_fido.h5')
    if epoch == 4000:
        classer.save_weights('models/jiandu-cnn/4000classer.h5')
        ed.save_weights('models/jiandu-cnn/4000ed.h5')
        # dd.save_weights('models/jiandu-cnn/dd.h5')
        # dis.save_weights('models/jiandu-cnn/dis.h5')
        # dis_model.save_weights('models/jiandu-cnn/dis_model.h5')
        class_model.save_weights('models/jiandu-cnn/4000class_model.h5')
        # sc_fido.save_weights('models/jiandu-cnn/sc_fido.h5')
print("%d [危险品分类loss: %f,acc: %.2f%%]" % (epoch, c_loss[0], 100 * c_loss[1]))
classer.save_weights('models/jiandu-cnn/classer.h5')
ed.save_weights('models/jiandu-cnn/ed.h5')
# dd.save_weights('models/jiandu-cnn/dd.h5')
# dis.save_weights('models/jiandu-cnn/dis.h5')
# dis_model.save_weights('models/jiandu-cnn/dis_model.h5')
class_model.save_weights('models/jiandu-cnn/class_model.h5')
# sc_fido.save_weights('models/jiandu-cnn/sc_fido.h5')
