...
# Rescale -1 to 1
trainfile_array, testfile_array = file_array2()#
...
X_train1 =train_feature_cut[:93*(lincut2 - cut1 * 2)]
...
X_train2 =train_feature_cut[93*(lincut2 - cut1 * 2):]
...
X_SCdata1=X_train1
X_SCdata2=X_train2
X_SCdata1_label=train_label_cut[:93*(lincut2 - cut1 * 2)]
X_SCdata2_label=train_label_cut[93*(lincut2 - cut1 * 2):]
X_SCdata1_domain_label=train_domain_label_cut[:93*(lincut2 - cut1 * 2)]
X_SCdata2_domain_label=train_domain_label_cut[93*(lincut2 - cut1 * 2):]
