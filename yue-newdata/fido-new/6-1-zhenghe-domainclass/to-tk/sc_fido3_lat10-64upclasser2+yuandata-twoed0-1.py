...
for epoch in range(epochs):
    ...
    if epoch % 1 == 0:
        ...
        if ((acc_non_pre3_vot >= 0.8) and (acc_yes_pre3_vot >= 0.8) and (c_loss[1] >= 0.7) and (
            ...
            c = int(c)
            print(k)
            classer.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed0-1/' + str(epoch) + '_' + str(c) + 'y' + str(
            ...
            ed.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed0-1/' + str(epoch) + '_' + str(c) + 'y' + str(
                acc_non_pre) + '_' + str(acc_yes_pre) + '_' + str(acc_non_pre_vot) + '_' + str(
                acc_yes_pre_vot) + 'm' + str(acc_non_pre3) + '_' + str(acc_yes_pre3) + '_' + str(
                acc_non_pre3_vot) + '_' + str(acc_yes_pre3_vot) + 'm' + str(acc_non_pre4) + '_' + str(
                acc_yes_pre4) + '_' + str(acc_non_pre4_vot) + '_' + str(acc_yes_pre4_vot) + 'ed.h5')
            dd.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed0-1/' + str(epoch) + '_' + str(c) + 'y' + str(
                acc_non_pre) + '_' + str(acc_yes_pre) + '_' + str(acc_non_pre_vot) + '_' + str(
                acc_yes_pre_vot) + 'm' + str(acc_non_pre3) + '_' + str(acc_yes_pre3) + '_' + str(
                acc_non_pre3_vot) + '_' + str(acc_yes_pre3_vot) + 'm' + str(acc_non_pre4) + '_' + str(
                acc_yes_pre4) + '_' + str(acc_non_pre4_vot) + '_' + str(acc_yes_pre4_vot) + 'dd.h5')
            dis.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed0-1/' + str(epoch) + '_' + str(c) + 'y' + str(
                acc_non_pre) + '_' + str(acc_yes_pre) + '_' + str(acc_non_pre_vot) + '_' + str(
                acc_yes_pre_vot) + 'm' + str(acc_non_pre3) + '_' + str(acc_yes_pre3) + '_' + str(
                acc_non_pre3_vot) + '_' + str(acc_yes_pre3_vot) + 'm' + str(acc_non_pre4) + '_' + str(
                acc_yes_pre4) + '_' + str(acc_non_pre4_vot) + '_' + str(acc_yes_pre4_vot) + 'dis.h5')
            dis_model.save_weights(
                'models/fido3_lat10-64upclasser2+yuandata-twoed0-1/' + str(epoch) + '_' + str(c) + 'y' + str(
                    acc_non_pre) + '_' + str(acc_yes_pre) + '_' + str(acc_non_pre_vot) + '_' + str(
                    acc_yes_pre_vot) + 'm' + str(acc_non_pre3) + '_' + str(acc_yes_pre3) + '_' + str(
                    acc_non_pre3_vot) + '_' + str(acc_yes_pre3_vot) + 'm' + str(acc_non_pre4) + '_' + str(
            ...
            sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata-twoed0-1/' + str(epoch) + '_' + str(c) + 'y' + str(
                acc_non_pre) + '_' + str(acc_yes_pre) + '_' + str(acc_non_pre_vot) + '_' + str(
                acc_yes_pre_vot) + 'm' + str(acc_non_pre3) + '_' + str(acc_yes_pre3) + '_' + str(
                acc_non_pre3_vot) + '_' + str(acc_yes_pre3_vot) + 'm' + str(acc_non_pre4) + '_' + str(
