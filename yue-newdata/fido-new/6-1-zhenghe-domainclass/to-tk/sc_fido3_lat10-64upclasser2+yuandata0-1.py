...
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        ...
        if ((acc_non_pre3 >= 0.65) and (acc_yes_pre3 >= 0.61)):
            ...
            print(k)
            classer.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'classer.h5')
            ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'ed.h5')
            dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'dd.h5')
            dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'dis.h5')
            dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'dis_model.h5')
            class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'class_model.h5')
            sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'sc_fido.h5')
    if epoch == 1000:
...
ed.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1/ed.h5')
dd.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1/dd.h5')
dis.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1/dis.h5')
dis_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1/dis_model.h5')
class_model.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1/class_model.h5')
sc_fido.save_weights('models/fido3_lat10-64upclasser2+yuandata0-1/sc_fido.h5')
