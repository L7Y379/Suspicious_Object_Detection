...
train_feature_ot=train_feature_ot.astype('float32')
test_feature_ot=test_feature_ot.astype('float32')
print(train_feature)
print(test_feature)
...
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        ...
        if ((acc_non_pre3>=0.95)and(acc_yes_pre3>=0.95)):
            k = k + 1
            print(k)
            classer.save_weights('models/jiandu-root/' + str(epoch) + 'classer.h5')
            ed.save_weights('models/jiandu-root/' + str(epoch) + 'ed.h5')
            ...
            class_model.save_weights('models/jiandu-root/' + str(epoch) + 'class_model.h5')
            # sc_fido.save_weights('models/jiandu/' + str(epoch) + 'sc_fido.h5')
    if epoch == 1000:
        classer.save_weights('models/jiandu-root/1000classer.h5')
        ed.save_weights('models/jiandu-root/1000ed.h5')
        ...
        class_model.save_weights('models/jiandu-root/1000class_model.h5')
        # sc_fido.save_weights('models/jiandu/sc_fido.h5')
    if epoch == 2000:
        classer.save_weights('models/jiandu-root/2000classer.h5')
        ed.save_weights('models/jiandu-root/2000ed.h5')
        # dd.save_weights('models/jiandu/dd.h5')
        # dis.save_weights('models/jiandu/dis.h5')
        # dis_model.save_weights('models/jiandu/dis_model.h5')
        class_model.save_weights('models/jiandu-root/2000class_model.h5')
        # sc_fido.save_weights('models/jiandu/sc_fido.h5')
    if epoch == 3000:
        classer.save_weights('models/jiandu-root/3000classer.h5')
        ed.save_weights('models/jiandu-root/3000ed.h5')
        # dd.save_weights('models/jiandu/dd.h5')
        # dis.save_weights('models/jiandu/dis.h5')
        # dis_model.save_weights('models/jiandu/dis_model.h5')
        class_model.save_weights('models/jiandu-root/3000class_model.h5')
        # sc_fido.save_weights('models/jiandu/sc_fido.h5')
    if epoch == 4000:
        classer.save_weights('models/jiandu-root/4000classer.h5')
        ed.save_weights('models/jiandu-root/4000ed.h5')
        # dd.save_weights('models/jiandu/dd.h5')
        # dis.save_weights('models/jiandu/dis.h5')
        # dis_model.save_weights('models/jiandu/dis_model.h5')
        class_model.save_weights('models/jiandu-root/4000class_model.h5')
        # sc_fido.save_weights('models/jiandu/sc_fido.h5')
print("%d [危险品分类loss: %f,acc: %.2f%%]" % (epoch, c_loss[0], 100 * c_loss[1]))
classer.save_weights('models/jiandu-root/classer.h5')
ed.save_weights('models/jiandu-root/ed.h5')
# dd.save_weights('models/jiandu/dd.h5')
# dis.save_weights('models/jiandu/dis.h5')
# dis_model.save_weights('models/jiandu/dis_model.h5')
class_model.save_weights('models/jiandu-root/class_model.h5')
# sc_fido.save_weights('models/jiandu/sc_fido.h5')
