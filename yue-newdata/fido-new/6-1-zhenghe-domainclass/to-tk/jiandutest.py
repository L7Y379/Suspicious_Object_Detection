...
# # Training
classer.load_weights('models/jiandulkrelu6/classer.h5')
ed.load_weights('models/jiandulkrelu6/ed.h5')
# dd.load_weights('models/jiandulkrelu6/4000dd.h5')
# dis.load_weights('models/jiandulkrelu6/4000dis.h5')
# dis_model.load_weights('models/jiandulkrelu6/4000dis_model.h5')
class_model.load_weights('models/jiandulkrelu6/class_model.h5')
# sc_fido.load_weights('models/jiandulkrelu6/4000sc_fido.h5')
k=0
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        ...
        if ((acc_non_pre3>=0.65)and(acc_yes_pre3>=0.61)):
            ...
            print(k)
            classer.save_weights('models/jiandu/' + str(epoch)+'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'classer.h5')
            ed.save_weights('models/jiandu/' + str(epoch)+'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+  'ed.h5')
            ...
            class_model.save_weights('models/jiandu/' + str(epoch)+'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot) + 'class_model.h5')
            # sc_fido.save_weights('models/jiandu/' + str(epoch) + 'sc_fido.h5')
    if epoch == 1000:
        classer.save_weights('models/jiandu/1000classer.h5')
        ed.save_weights('models/jiandu/1000ed.h5')
        ...
        class_model.save_weights('models/jiandu/1000class_model.h5')
        # sc_fido.save_weights('models/jiandu/sc_fido.h5')
    if epoch == 2000:
        classer.save_weights('models/jiandu/2000classer.h5')
        ed.save_weights('models/jiandu/2000ed.h5')
        # dd.save_weights('models/jiandu/dd.h5')
        # dis.save_weights('models/jiandu/dis.h5')
        # dis_model.save_weights('models/jiandu/dis_model.h5')
        class_model.save_weights('models/jiandu/2000class_model.h5')
        # sc_fido.save_weights('models/jiandu/sc_fido.h5')
    if epoch == 3000:
        classer.save_weights('models/jiandu/3000classer.h5')
        ed.save_weights('models/jiandu/3000ed.h5')
        # dd.save_weights('models/jiandu/dd.h5')
        # dis.save_weights('models/jiandu/dis.h5')
        # dis_model.save_weights('models/jiandu/dis_model.h5')
        class_model.save_weights('models/jiandu/3000class_model.h5')
        # sc_fido.save_weights('models/jiandu/sc_fido.h5')
    if epoch == 4000:
        classer.save_weights('models/jiandu/4000classer.h5')
        ed.save_weights('models/jiandu/4000ed.h5')
        # dd.save_weights('models/jiandu/dd.h5')
        # dis.save_weights('models/jiandu/dis.h5')
        # dis_model.save_weights('models/jiandu/dis_model.h5')
        class_model.save_weights('models/jiandu/4000class_model.h5')
        # sc_fido.save_weights('models/jiandu/sc_fido.h5')
print("%d [危险品分类loss: %f,acc: %.2f%%]" % (epoch, c_loss[0], 100 * c_loss[1]))
