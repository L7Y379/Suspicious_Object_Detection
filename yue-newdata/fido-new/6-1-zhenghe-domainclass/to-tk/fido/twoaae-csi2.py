...
for epoch in range(epochs):
    ...
    if epoch==1000:
        discriminator.save_weights('models/aae-csi2/1000discriminator.h5')
        #discriminator2.save_weights('models/aae-csi2/discriminator2.h5')
        encoder.save_weights('models/aae-csi2/1000encoder.h5')
        #encoder2.save_weights('models/aae-csi2/encoder2.h5')
        adversarial_autoencoder.save_weights('models/aae-csi2/1000adversarial_autoencoder.h5')
        #adversarial_autoencoder2.save_weights('models/aae-csi2/adversarial_autoencoder2.h5')
    if epoch==2000:
        discriminator.save_weights('models/aae-csi2/2000discriminator.h5')
        #discriminator2.save_weights('models/aae-csi2/discriminator2.h5')
        encoder.save_weights('models/aae-csi2/2000encoder.h5')
        #encoder2.save_weights('models/aae-csi2/encoder2.h5')
        adversarial_autoencoder.save_weights('models/aae-csi2/2000adversarial_autoencoder.h5')
        #adversarial_autoencoder2.save_weights('models/aae-csi2/adversarial_autoencoder2.h5')
    if epoch==2300:
        discriminator.save_weights('models/aae-csi2/2300discriminator.h5')
        #discriminator2.save_weights('models/aae-csi2/discriminator2.h5')
        encoder.save_weights('models/aae-csi2/2300encoder.h5')
        #encoder2.save_weights('models/aae-csi2/encoder2.h5')
        adversarial_autoencoder.save_weights('models/aae-csi2/2300adversarial_autoencoder.h5')
       #adversarial_autoencoder2.save_weights('models/aae-csi2/adversarial_autoencoder2.h5')
    if epoch==2400:
        discriminator.save_weights('models/aae-csi2/2400discriminator.h5')
        #discriminator2.save_weights('models/aae-csi2/discriminator2.h5')
        encoder.save_weights('models/aae-csi2/2400encoder.h5')
        #encoder2.save_weights('models/aae-csi2/encoder2.h5')
        adversarial_autoencoder.save_weights('models/aae-csi2/2400adversarial_autoencoder.h5')
        #adversarial_autoencoder2.save_weights('models/aae-csi2/adversarial_autoencoder2.h5')
...
for epoch in range(epochs):
    ...
    if epoch==1000:
        ...
        discriminator2.save_weights('models/aae-csi2/1000discriminator2.h5')
        #encoder.save_weights('models/aae-csi2/encoder.h5')
        encoder2.save_weights('models/aae-csi2/1000encoder2.h5')
        #adversarial_autoencoder.save_weights('models/aae-csi2/adversarial_autoencoder.h5')
        adversarial_autoencoder2.save_weights('models/aae-csi2/1000adversarial_autoencoder2.h5')
    if epoch==2000:
        #discriminator.save_weights('models/aae-csi2/discriminator.h5')
        discriminator2.save_weights('models/aae-csi2/2000discriminator2.h5')
        #encoder.save_weights('models/aae-csi2/encoder.h5')
        encoder2.save_weights('models/aae-csi2/2000encoder2.h5')
        #adversarial_autoencoder.save_weights('models/aae-csi2/adversarial_autoencoder.h5')
        adversarial_autoencoder2.save_weights('models/aae-csi2/2000adversarial_autoencoder2.h5')
    if epoch==2300:
        #discriminator.save_weights('models/aae-csi2/discriminator.h5')
        discriminator2.save_weights('models/aae-csi2/2300discriminator2.h5')
        #encoder.save_weights('models/aae-csi2/encoder.h5')
        encoder2.save_weights('models/aae-csi2/2300encoder2.h5')
        #adversarial_autoencoder.save_weights('models/aae-csi2/adversarial_autoencoder.h5')
        adversarial_autoencoder2.save_weights('models/aae-csi2/2300adversarial_autoencoder2.h5')
    if epoch==2400:
        #discriminator.save_weights('models/aae-csi2/discriminator.h5')
        discriminator2.save_weights('models/aae-csi2/2400discriminator2.h5')
        #encoder.save_weights('models/aae-csi2/encoder.h5')
        encoder2.save_weights('models/aae-csi2/2400encoder2.h5')
        #adversarial_autoencoder.save_weights('models/aae-csi2/adversarial_autoencoder.h5')
        adversarial_autoencoder2.save_weights('models/aae-csi2/2400adversarial_autoencoder2.h5')
    # Save generated images (every sample interval, e.g. every 100th epoch)
    # if epoch % sample_interval == 0:
