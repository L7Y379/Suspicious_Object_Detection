...
# # Training
classer.load_weights('models/fido3_lat10-64upclasser(1)zhengjiashuju/500classer.h5')
ed.load_weights('models/fido3_lat10-64upclasser(1)zhengjiashuju/500ed.h5')
dd.load_weights('models/fido3_lat10-64upclasser(1)zhengjiashuju/500dd.h5')
sc_fido.load_weights('models/fido3_lat10-64upclasser(1)zhengjiashuju/500sc_fido.h5')
k=0
