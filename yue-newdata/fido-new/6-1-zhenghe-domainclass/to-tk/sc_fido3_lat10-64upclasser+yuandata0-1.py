...
def get_dis(x):
    return x[:,latent_dim:]
encoded_repr3 = Lambda(get_dis)(encoded_repr3)
validity = dis(encoded_repr3)
dis_model=Model(img3,validity)
dis_model.compile(loss='categorical_crossentropy', optimizer=opt, metrics=['accuracy'])

# # Training
# classer.load_weights('models/fido3_lat10-64upclasser+yuandata0-1/4000classer.h5')
# ed.load_weights('models/fido3_lat10-64upclasser+yuandata0-1/4000ed.h5')
# dd.load_weights('models/fido3_lat10-64upclasser+yuandata0-1/4000dd.h5')
# dis.load_weights('models/fido3_lat10-64upclasser+yuandata0-1/4000dis.h5')
# dis_model.load_weights('models/fido3_lat10-64upclasser+yuandata0-1/4000dis_model.h5')
# class_model.load_weights('models/fido3_lat10-64upclasser+yuandata0-1/4000class_model.h5')
# sc_fido.load_weights('models/fido3_lat10-64upclasser+yuandata0-1/4000sc_fido.h5')
k=0
for epoch in range(epochs):
    ...
    c_loss = classer.train_on_batch(latent_mid[:, :latent_dim], X_SCdata_label[idx])
    # ---------------------
    #  Train dis
    # ---------------------
    ...
    if epoch % 10 == 0:
        ...
        if ((acc_non_pre3 >= 0.65) and (acc_yes_pre3 >= 0.61)):
            ...
            print(k)
            classer.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'classer.h5')
            ed.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'ed.h5')
            dd.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'dd.h5')
            dis.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'dis.h5')
            dis_model.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'dis_model.h5')
            #class_model.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'class_model.h5')
            sc_fido.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/' + str(epoch) +'_' +str(acc_non_pre)+'_'+str(acc_yes_pre)+'_' +str(acc_non_pre_vot)+'_'+str(acc_yes_pre_vot)+'_mubiao' +str(acc_non_pre3)+'_'+str(acc_yes_pre3)+'_' +str(acc_non_pre3_vot)+'_'+str(acc_yes_pre3_vot)+ 'sc_fido.h5')
    if epoch == 1000:
        classer.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/1000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/1000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/1000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/1000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/1000dis_model.h5')
        #class_model.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/1000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/1000sc_fido.h5')
    if epoch == 2000:
        classer.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/2000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/2000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/2000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/2000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/2000dis_model.h5')
        #class_model.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/2000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/2000sc_fido.h5')
    if epoch == 3000:
        classer.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/3000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/3000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/3000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/3000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/3000dis_model.h5')
        #class_model.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/3000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/3000sc_fido.h5')
    if epoch == 4000:
        classer.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/4000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/4000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/4000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/4000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/4000dis_model.h5')
        #class_model.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/4000class_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/4000sc_fido.h5')
print("%d [危险品分类loss: %f,acc: %.2f%%,域分类loss: %f,acc: %.2f%%,重构loss: %f]" % (
epoch, c_loss[0], 100 * c_loss[1],d_loss[0],100 * d_loss[1], sc_fido_loss))
classer.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/classer.h5')
ed.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/ed.h5')
dd.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/dd.h5')
dis.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/dis.h5')
dis_model.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/dis_model.h5')
#class_model.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/class_model.h5')
sc_fido.save_weights('models/fido3_lat10-64upclasser+yuandata0-1/sc_fido.h5')
