...
X_SCdata1_label=train_label[:lin2*70]
X_SCdata2_label=train_label[lin2*70:]
...
classer.load_weights('models/fido3_lat10-64upclasser/1000classer.h5')
ed.load_weights('models/fido3_lat10-64upclasser/1000ed.h5')
dd.load_weights('models/fido3_lat10-64upclasser/1000dd.h5')
dis.load_weights('models/fido3_lat10-64upclasser/1000dis.h5')
dis_model.load_weights('models/fido3_lat10-64upclasser/1000dis_model.h5')
sc_fido.load_weights('models/fido3_lat10-64upclasser/1000sc_fido.h5')
...
non_mid=ed.predict(X_SCdata1[:70*lin2])
non_mid=non_mid[:,:latent_dim]
non_pre=classer.predict(non_mid)
yes_mid=ed.predict(X_SCdata2[:70*lin2])
yes_mid=yes_mid[:,:latent_dim]
yes_pre=classer.predict(yes_mid)
print(non_mid)
print(non_mid.shape)
...
non_mid3=ed.predict(train_feature_ot[:lin2*30])
non_mid3=non_mid3[:,:latent_dim]
non_pre3=classer.predict(non_mid3)
yes_mid3=ed.predict(train_feature_ot[lin2*30:])
