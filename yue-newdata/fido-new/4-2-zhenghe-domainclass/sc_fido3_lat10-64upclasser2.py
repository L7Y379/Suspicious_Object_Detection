...
print(train_feature)
print(test_feature)
X_train1 =train_feature[:70*lin2]
...
X_train2 =train_feature[70*lin2:]
...
data=sample_prior(latent_dim, 70*lin2)
...
X_SCdata1_label=train_label[:70*lin2]
X_SCdata2_label=train_label[70*lin2:]
X_SCdata1_domain_label=train_domain_label[:70*lin2]
X_SCdata2_domain_label=train_domain_label[70*lin2:]
...
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        ...
        if ((100 * c_loss[1] >= 98.3) and (100 * d_loss[1] >= 55)):
            i=i+1
            classer.save_weights('models/fido3_lat10-64upclasser2/'+str(epoch)+'classer.h5')
            ed.save_weights('models/fido3_lat10-64upclasser2/'+str(epoch)+'ed.h5')
            dd.save_weights('models/fido3_lat10-64upclasser2/'+str(epoch)+'dd.h5')
            dis.save_weights('models/fido3_lat10-64upclasser2/'+str(epoch)+'dis.h5')
            dis_model.save_weights('models/fido3_lat10-64upclasser2/'+str(epoch)+'dis_model.h5')
            sc_fido.save_weights('models/fido3_lat10-64upclasser2/'+str(epoch)+'sc_fido.h5')
            if i==5:
                break
    if epoch >= 3000:
        if ((100 * c_loss[1]>=98.3)and(100 * d_loss[1]>=55)):
    ...
    if epoch==1000:
        classer.save_weights('models/fido3_lat10-64upclasser2/1000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2/1000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2/1000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2/1000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2/1000dis_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2/1000sc_fido.h5')
    if epoch==2000:
        classer.save_weights('models/fido3_lat10-64upclasser2/2000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2/2000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2/2000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2/2000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2/2000dis_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2/2000sc_fido.h5')
    if epoch==3000:
        classer.save_weights('models/fido3_lat10-64upclasser2/3000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2/3000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2/3000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2/3000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2/3000dis_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2/3000sc_fido.h5')
    if epoch==4000:
        classer.save_weights('models/fido3_lat10-64upclasser2/4000classer.h5')
        ed.save_weights('models/fido3_lat10-64upclasser2/4000ed.h5')
        dd.save_weights('models/fido3_lat10-64upclasser2/4000dd.h5')
        dis.save_weights('models/fido3_lat10-64upclasser2/4000dis.h5')
        dis_model.save_weights('models/fido3_lat10-64upclasser2/4000dis_model.h5')
        sc_fido.save_weights('models/fido3_lat10-64upclasser2/4000sc_fido.h5')
print("%d [危险品分类loss: %f,acc: %.2f%%,域分类loss: %f,acc: %.2f%%,重构loss: %f]" % (
epoch, c_loss[0], 100 * c_loss[1],d_loss[0],100 * d_loss[1], sc_fido_loss))
...
class_model.save_weights('models/fido3_lat10-64upclasser2/class_model.h5')
