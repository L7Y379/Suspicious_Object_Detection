...
#train_feature_nosiy = train_feature+0.3 * np.random.normal(loc=0., scale=1., size=train_feature.shape)
#test_feature_nosiy = test_feature+0.3 * np.random.normal(loc=0., scale=1., size=test_feature.shape)
